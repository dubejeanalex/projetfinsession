...
$("#couprevert").click(function(){
    $("#descriptioncouprevert").html("                Le coup du revert est souvent une option qu'on ne choisit pas,\n" +
...
$("#service").click(function(){
    $("#descriptionservice").html("                       Le service est un des coups qui fait une grande différence dans une partie. C'est le coup initial et il est très important de le maîtriser.\n" +
        "                Le joueur a la possibilité de faire 2 services. Il doit donc essayer de faire un service très puissant le premier coup. Dans le cas où il fait une faute, il fait un deuxième service souvent moins rapide pour éviter de faire 2 fautes et perdre le point        ");
